...
\renewcommand{\tableofcontents}{%
	\chapter*{%
	  \vspace*{-20\p@}%
	  \begin{tikzpicture}[remember picture, overlay]%
		  \pgftext[right,x=16cm,y=0.1cm]{\color{doc!60}\Huge\sc\bfseries Содержание}; %\contentsname};%
		  \draw[fill=doc!60,draw=doc!60] (13,-.75) rectangle (20,1);%
		  \clip (13,-.75) rectangle (20,1);
		  \pgftext[right,x=16cm,y=0.1cm]{\color{white}\Huge\sc\bfseries Содержание};
		  %\contentsname};%
	  \end{tikzpicture}}%
	\@starttoc{toc}}
\makeatother
